/**
 * Created by bankeys-01 on 2016/4/14.
 */
(function(f) {
    ...
    q(A.prototype, {
        ...
        getSVG: function(a) {
            ...
            e.destroy();
            s(c);
            if (J && (c = g.match(/<\/svg>(.*?$)/))) c = '<foreignObject x="0" y="0" width="200" height="200"><body xmlns="http://www.w3.org/1999/xhtml">' + c[1] + "</body></foreignObject>",
        ...
        print: function() {
            ...
            if (!a.isPrinting) a.isPrinting = !0, a.pointer.reset(null, 0), C(a, "beforePrint"),
                i(j, function(a, b) {
        ...
        contextMenu: function(a, b, e, c, f, j, k) {
            var d = this, l = d.options.navigation, D = l.menuItemStyle, o = d.chartWidth, p = d.chartHeight, E = "cache-" + a, h = d[E], u = G(f, j), w, x, r, s = function(b) {
            ...
            e + d.exportMenuWidth > o ? b.right = o - e - f - u + "px" : b.left = e - u + "px";
